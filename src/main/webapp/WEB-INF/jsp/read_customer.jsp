    ...
    <div class="container nav_bar_container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right manu_ul">
                <li class="active"><a href="/read-customer">CUSTOMERS</a></li>
    ...
    <thead>
        ...
        <c:forEach var="customer" items="${customers}">
            <tr>
                ...
                <td><a href="/update-customer/${customer.id}"><button class="btn btn-default custom_btn"style="width: auto;">UPDATE</button></a></td>
